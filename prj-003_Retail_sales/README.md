...
```sql
CREATE DATABASE p1\_retail\_db;
...
SELECT 
    category,    
    COUNT(DISTINCT customer\_id) as cnt\_unique\_cs
FROM retail\_sales
GROUP BY category
```
